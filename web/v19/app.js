/* =====================================================================
   Multicultural Library Mall v19 — Enchanted Forest Treehouse
   Three.js treehouse hero · 3D exhibition engine (spiral shelf / firefly circle / mushroom stands)
...
(function () {
  ...
  const I18N = {
    KO: {
      ...
      heroEyebrow: 'MULTICULTURAL LIBRARY COLLECTION · 2026', heroTitle: '세계의 이야기가<br>숲속 트리하우스에 깃듭니다', heroSub: '다문화 도서관을 위한 원서·이중언어 그림책 큐레이션. 사서를 위한 서지정보와 공문 견적을 한 화면에서.', heroCta1: '3D 전시실 입장', heroCta2: '도서 검색하기', statTitles: '보유 종수', statLangs: '지원 언어', statLibs: '납품 도서관', heroHint: '마우스를 움직여 반딧불이를 깨워보세요',
      exhibEyebrow: '3D EXHIBITION HALL', exhibTitle: '마법의 숲 트리하우스 기획전', exhibSub: '기획전마다 다른 진열 형태로 책을 만나보세요. 책을 클릭하면 상세로 이동합니다.',
      newEyebrow: 'NEW ARRIVALS', newTitle: '2026 하반기 신간', viewList: '서지 리스트', viewParade: '낙엽 책 3D', paradeCaption: '신간 도서가 나뭇잎처럼 내려옵니다 — 클릭하면 상세로',
      ...
      curEyebrow: 'CURATION EXHIBITIONS', curTitle: '기획전 3D 전시실', curSub: '나선형 서가·반딧불이 서클·버섯 전시대, 세 가지 3D 전시 형태의 기획전. 사서 패키지 일괄 담기를 지원합니다.',
      ...
      layoutCarousel: '나선형 트리하우스 서가', layoutBalloon: '반딧불이 서클', layoutStairs: '버섯 전시대', hintDrag: '드래그하여 회전 · 책 클릭 시 상세',
    ...
    EN: {
      ...
      heroEyebrow: 'MULTICULTURAL LIBRARY COLLECTION · 2026', heroTitle: 'Stories of the world<br>nest in a forest treehouse', heroSub: 'Original-language and bilingual picture books curated for multicultural libraries. Bibliographic data and official quotes for librarians, on one screen.', heroCta1: 'Enter 3D Hall', heroCta2: 'Search books', statTitles: 'Titles', statLangs: 'Languages', statLibs: 'Libraries served', heroHint: 'Move your mouse to wake the fireflies',
      exhibEyebrow: '3D EXHIBITION HALL', exhibTitle: 'Enchanted Treehouse Exhibitions', exhibSub: 'Every exhibition displays books in a different form. Click a book to open its detail.',
      newEyebrow: 'NEW ARRIVALS', newTitle: 'New Titles · Fall 2026', viewList: 'Bibliographic list', viewParade: 'Falling-Leaf Books 3D', paradeCaption: 'New titles drift down like leaves — click to open',
      ...
      curEyebrow: 'CURATION EXHIBITIONS', curTitle: '3D Exhibition Halls', curSub: 'Spiral shelf, firefly circle and mushroom stands — three 3D display forms. Add a whole package in one click.',
      ...
      layoutCarousel: 'Spiral Treehouse Shelf', layoutBalloon: 'Firefly Circle', layoutStairs: 'Mushroom Stands', hintDrag: 'Drag to rotate · click a book for detail',
    ...
    VI: {
      ...
      heroEyebrow: 'BỘ SƯU TẬP THƯ VIỆN ĐA VĂN HÓA · 2026', heroTitle: 'Những câu chuyện thế giới<br>trú trong ngôi nhà trên cây', heroSub: 'Sách tranh nguyên bản và song ngữ được tuyển chọn cho thư viện đa văn hóa. Thông tin thư mục và báo giá công văn cho thủ thư trên một màn hình.', heroCta1: 'Vào phòng 3D', heroCta2: 'Tìm sách', statTitles: 'Đầu sách', statLangs: 'Ngôn ngữ', statLibs: 'Thư viện', heroHint: 'Di chuyển chuột để đánh thức đom đóm',
      exhibEyebrow: 'PHÒNG TRIỂN LÃM 3D', exhibTitle: 'Triển lãm Nhà trên cây Kỳ diệu', exhibSub: 'Mỗi triển lãm trưng bày sách theo hình thức khác nhau. Nhấp vào sách để xem chi tiết.',
      newEyebrow: 'SÁCH MỚI', newTitle: 'Sách mới · Cuối 2026', viewList: 'Danh sách thư mục', viewParade: 'Sách lá rơi 3D', paradeCaption: 'Sách mới rơi như lá — nhấp để mở',
      ...
      curEyebrow: 'TRIỂN LÃM TUYỂN CHỌN', curTitle: 'Phòng triển lãm 3D', curSub: 'Kệ xoắn, vòng đom đóm, giá nấm — ba hình thức trưng bày 3D.',
      ...
      layoutCarousel: 'Kệ xoắn Nhà cây', layoutBalloon: 'Vòng Đom đóm', layoutStairs: 'Giá Nấm', hintDrag: 'Kéo để xoay · nhấp sách để xem',
    ...
    ZH: {
      ...
      heroEyebrow: '多文化图书馆馆藏 · 2026', heroTitle: '世界的故事<br>栖于森林树屋', heroSub: '为多文化图书馆精选的原版与双语绘本。馆员所需的书目信息与公文报价，一屏搞定。', heroCta1: '进入3D展厅', heroCta2: '检索图书', statTitles: '藏书种数', statLangs: '支持语言', statLibs: '供货图书馆', heroHint: '移动鼠标唤醒萤火虫',
      exhibEyebrow: '3D 展厅', exhibTitle: '魔法森林树屋特展', exhibSub: '每个特展以不同形式陈列图书。点击图书查看详情。',
      newEyebrow: '新书上架', newTitle: '2026 下半年新书', viewList: '书目列表', viewParade: '落叶图书 3D', paradeCaption: '新书如落叶飘下 — 点击查看',
      ...
      curEyebrow: '策展特展', curTitle: '特展 3D 展厅', curSub: '螺旋书架、萤火虫圈、蘑菇展台——三种3D陈列形式。支持一键加入整套套餐。',
      ...
      layoutCarousel: '螺旋树屋书架', layoutBalloon: '萤火虫圈', layoutStairs: '蘑菇展台', hintDrag: '拖动旋转 · 点击图书查看详情',
    ...
    RU: {
      ...
      heroEyebrow: 'КОЛЛЕКЦИЯ МУЛЬТИКУЛЬТУРНОЙ БИБЛИОТЕКИ · 2026', heroTitle: 'Истории мира<br>живут в лесном домике на дереве', heroSub: 'Оригинальные и двуязычные книжки-картинки для мультикультурных библиотек. Библиографические данные и официальная смета для библиотекаря на одном экране.', heroCta1: 'Войти в 3D-зал', heroCta2: 'Искать книги', statTitles: 'Наименований', statLangs: 'Языков', statLibs: 'Библиотек', heroHint: 'Двигайте мышью, чтобы разбудить светлячков',
      exhibEyebrow: '3D ВЫСТАВОЧНЫЙ ЗАЛ', exhibTitle: 'Выставки волшебного домика на дереве', exhibSub: 'Каждая выставка показывает книги по-своему. Нажмите на книгу, чтобы открыть карточку.',
      newEyebrow: 'НОВИНКИ', newTitle: 'Новинки · осень 2026', viewList: 'Библиографический список', viewParade: 'Книги-листья 3D', paradeCaption: 'Новинки падают как листья — нажмите, чтобы открыть',
      ...
      curEyebrow: 'КУРАТОРСКИЕ ВЫСТАВКИ', curTitle: '3D выставочные залы', curSub: 'Спиральная полка, круг светлячков и грибные стенды — три формы 3D-показа.',
      ...
      layoutCarousel: 'Спиральная полка', layoutBalloon: 'Круг светлячков', layoutStairs: 'Грибные стенды', hintDrag: 'Перетащите для вращения · клик по книге',
    ...
    JA: {
      ...
      heroEyebrow: '多文化図書館コレクション · 2026', heroTitle: '世界の物語が<br>森のツリーハウスに宿る', heroSub: '多文化図書館のための原書・バイリンガル絵本キュレーション。司書のための書誌情報と公文見積をひとつの画面で。', heroCta1: '3D展示室へ', heroCta2: '図書を検索', statTitles: '所蔵点数', statLangs: '対応言語', statLibs: '納入図書館', heroHint: 'マウスを動かしてホタルを起こそう',
      exhibEyebrow: '3D 展示ホール', exhibTitle: '魔法の森ツリーハウス企画展', exhibSub: '企画展ごとに異なる陳列形式。本をクリックすると詳細へ。',
      newEyebrow: '新刊', newTitle: '2026 下半期 新刊', viewList: '書誌リスト', viewParade: '落ち葉ブック 3D', paradeCaption: '新刊が木の葉のように舞い降りる — クリックで詳細',
      ...
      curEyebrow: 'キュレーション企画展', curTitle: '企画展 3D 展示室', curSub: '螺旋本棚・ホタルサークル・きのこ展示台、3つの3D陳列形式。パッケージ一括追加に対応。',
      ...
      layoutCarousel: '螺旋ツリーハウス本棚', layoutBalloon: 'ホタルサークル', layoutStairs: 'きのこ展示台', hintDrag: 'ドラッグで回転 · 本をクリックで詳細',
  ...
  const CURATIONS = [
    { id: 'c1', layout: 'carousel', t: { KO: '세계 숲 이야기 나선전', EN: 'World Forest Tales Spiral', VI: 'Vòng xoắn Chuyện rừng Thế giới', ZH: '世界森林故事螺旋展', RU: 'Спираль лесных сказок мира', JA: '世界の森ものがたり螺旋展' }, d: { KO: '나무 둥치를 따라 올라가는 나선형 서가에서 세계의 숲·자연 전래동화를 만납니다.', EN: 'Meet forest and nature folk tales on a spiral shelf winding up the trunk.', VI: 'Gặp cổ tích rừng và thiên nhiên trên kệ xoắn quanh thân cây.', ZH: '沿树干螺旋而上的书架，遇见世界森林与自然传说。', RU: 'Сказки о лесе и природе на спиральной полке вокруг ствола.', JA: '幹を巻き上がる螺旋本棚で森と自然の民話に出会う。' }, books: ['b07', 'b01', 'b03', 'b08', 'b02', 'b06', 'b12', 'b05'] },
    { id: 'c2', layout: 'balloon', t: { KO: '이중언어 자연 그림책 반딧불이전', EN: 'Bilingual Nature Picture Books · Firefly Circle', VI: 'Sách tranh Thiên nhiên Song ngữ · Vòng Đom đóm', ZH: '双语自然绘本萤火虫展', RU: 'Двуязычные книжки о природе · круг светлячков', JA: 'バイリンガル自然絵本 ホタルサークル展' }, d: { KO: '반딧불이가 비추는 원형 나무 그루터기 위에 두 언어 그림책이 놓입니다. 다문화 가정 첫 책 추천.', EN: 'Bilingual picture books rest on stumps lit by fireflies. First books for multicultural families.', VI: 'Sách tranh song ngữ đặt trên gốc cây được đom đóm soi sáng.', ZH: '双语绘本安放在萤火虫照亮的树桩上。多文化家庭的第一本书。', RU: 'Двуязычные книжки на пнях в свете светлячков.', JA: 'ホタルが照らす切り株の上にバイリンガル絵本。' }, books: ['b05', 'b10', 'b01', 'b08', 'b06', 'b12'] },
    { id: 'c3', layout: 'stairs', t: { KO: '청소년 세계문학 버섯 전시대전', EN: 'Youth World Literature · Mushroom Stands', VI: 'Văn học Thiếu niên · Giá Nấm', ZH: '青少年世界文学蘑菇展台展', RU: 'Мировая литература для подростков · грибные стенды', JA: 'YA世界文学 きのこ展示台展' }, d: { KO: '높이가 다른 버섯 전시대 위에 청소년 소설과 논픽션이 놓입니다. 학교도서관 추천 패키지.', EN: 'Youth novels and non-fiction on mushroom stands of different heights. Recommended for school libraries.', VI: 'Tiểu thuyết và phi hư cấu thiếu niên trên giá nấm cao thấp khác nhau.', ZH: '青少年小说与非虚构立于高低不同的蘑菇展台。学校图书馆推荐。', RU: 'Подростковые романы и нон-фикшн на грибных стендах разной высоты.', JA: '高さの違うきのこ台にYA小説とノンフィクション。' }, books: ['b04', 'b09', 'b11', 'b03', 'b07', 'b02', 'b12'] }
  ];
  const NEW_IDS = ['b01', 'b02', 'b04', 'b05', 'b07', 'b09', 'b10', 'b12'];
  const SUPPLY = 0.9;

  /* ---------------- 3. State ---------------- */
  let lang = localStorage.getItem('mlm19_lang') || 'KO';
  let soundOn = localStorage.getItem('mlm19_sound') !== 'off';
  let cart = JSON.parse(localStorage.getItem('mlm19_cart') || '{}');
  ...
  /* ---------------- 5. FX: fireflies + wood knock chime ---------------- */
  ...
  function burst(x, y) {
    for (let i = 0; i < 22; i++) { const a = Math.random() * Math.PI * 2, s = .8 + Math.random() * 3; parts.push({ x, y, vx: Math.cos(a) * s, vy: Math.sin(a) * s - .8, life: 1 + Math.random() * .4, r: 1.5 + Math.random() * 2.5, c: Math.random() < .8 ? '#F2CF7A' : '#9FE39B', ph: Math.random() * 6, leaf: Math.random() < .25 }); }
  }
  (function fxLoop() {
    fxg.clearRect(0, 0, innerWidth, innerHeight);
    parts = parts.filter((p) => p.life > 0);
    for (const p of parts) {
      p.life -= .014; p.vx += Math.sin(p.ph + p.life * 10) * .08; p.vy += p.leaf ? .05 : -.02; p.vx *= .97; p.vy *= .97; p.x += p.vx; p.y += p.vy;
      const flick = .55 + .45 * Math.sin(p.life * 30 + p.ph);
      fxg.globalAlpha = Math.max(0, Math.min(1, p.life)) * flick;
      if (p.leaf) { fxg.fillStyle = '#7FA36C'; fxg.beginPath(); fxg.ellipse(p.x, p.y, Math.max(0, p.r * 1.8), Math.max(0, p.r * .9), p.ph + p.life * 4, 0, Math.PI * 2); fxg.fill(); continue; }
      const grd = fxg.createRadialGradient(p.x, p.y, 0, p.x, p.y, p.r * 4); grd.addColorStop(0, p.c); grd.addColorStop(1, 'rgba(242,207,122,0)');
      fxg.fillStyle = grd; fxg.beginPath(); fxg.arc(p.x, p.y, Math.max(0, p.r * 4), 0, Math.PI * 2); fxg.fill();
      fxg.fillStyle = '#fff8d6'; fxg.beginPath(); fxg.arc(p.x, p.y, Math.max(0, p.r * .8), 0, Math.PI * 2); fxg.fill();
    }
  ...
  function chime() {
    ...
    try {
      ...
      if (!noiseBuf) { noiseBuf = actx.createBuffer(1, actx.sampleRate * .12, actx.sampleRate); const d = noiseBuf.getChannelData(0); for (let i = 0; i < d.length; i++) d[i] = (Math.random() * 2 - 1) * Math.pow(1 - i / d.length, 3); }
      const src = actx.createBufferSource(); src.buffer = noiseBuf; const lp = actx.createBiquadFilter(); lp.type = 'lowpass'; lp.frequency.value = 900; const g = actx.createGain(); g.gain.value = .5;
      src.connect(lp).connect(g).connect(actx.destination); src.start(now);
      [659.3, 987.8].forEach((f, i) => { const o = actx.createOscillator(), gg = actx.createGain(); o.type = 'sine'; o.frequency.value = f; gg.gain.setValueAtTime(0, now + .05 + i * .09); gg.gain.linearRampToValueAtTime(.12, now + .06 + i * .09); gg.gain.exponentialRampToValueAtTime(.0001, now + 1.1 + i * .09); o.connect(gg).connect(actx.destination); o.start(now + .05 + i * .09); o.stop(now + 1.3 + i * .09); });
    } catch (e) { /* ignore */ }
  }
  ...
  /* ---------------- 8. Hero: giant tree with spiral treehouse shelves ---------------- */
  const BARK = () => new THREE.MeshStandardMaterial({ color: 0x5A3A22, roughness: .95 });
  const WOOD = () => new THREE.MeshStandardMaterial({ color: 0x8B5E3C, roughness: .8 });
  const BRASS = () => new THREE.MeshStandardMaterial({ color: 0xE3B341, metalness: .8, roughness: .3 });
  function fireflies(N, spread, yMin, yMax) {
    const pos = new Float32Array(N * 3), ph = new Float32Array(N);
    for (let i = 0; i < N; i++) { pos[i * 3] = (Math.random() - .5) * spread; pos[i * 3 + 1] = yMin + Math.random() * (yMax - yMin); pos[i * 3 + 2] = (Math.random() - .5) * spread; ph[i] = Math.random() * 6; }
    const g = new THREE.BufferGeometry(); g.setAttribute('position', new THREE.BufferAttribute(pos, 3));
    if (!fireflies.tex) { const c = document.createElement('canvas'); c.width = c.height = 64; const g2 = c.getContext('2d'); const gr = g2.createRadialGradient(32, 32, 0, 32, 32, 32); gr.addColorStop(0, 'rgba(255,250,220,1)'); gr.addColorStop(.3, 'rgba(242,207,122,.9)'); gr.addColorStop(1, 'rgba(242,207,122,0)'); g2.fillStyle = gr; g2.fillRect(0, 0, 64, 64); fireflies.tex = new THREE.CanvasTexture(c); }
    const mat = new THREE.PointsMaterial({ color: 0xF2CF7A, size: .5, map: fireflies.tex, transparent: true, opacity: .9, blending: THREE.AdditiveBlending, depthWrite: false });
    const pts = new THREE.Points(g, mat); pts.userData = { ph, N };
    pts.tick = (dt, el) => { const a = g.attributes.position.array; for (let i = 0; i < N; i++) { a[i * 3] += Math.sin(el * .7 + ph[i]) * .006; a[i * 3 + 1] += Math.cos(el * .5 + ph[i] * 1.3) * .005; a[i * 3 + 2] += Math.sin(el * .6 + ph[i] * .7) * .006; } g.attributes.position.needsUpdate = true; mat.opacity = .55 + Math.sin(el * 3) * .35; };
    return pts;
  }
  const hero = (() => {
    const canvas = $('#hero-canvas'); const renderer = makeRenderer(canvas);
    const scene = new THREE.Scene(); scene.fog = new THREE.FogExp2(0x0B2219, .045);
    const camera = new THREE.PerspectiveCamera(44, 2, .1, 100); camera.position.set(5, 3, 15);
    scene.add(new THREE.HemisphereLight(0x3F6B4E, 0x1A120A, .7));
    const moon = new THREE.DirectionalLight(0xBFD8C8, .5); moon.position.set(-6, 14, 6); moon.castShadow = true; scene.add(moon);
    const group = new THREE.Group(); group.position.set(4, -3.5, 0); scene.add(group);
    // ground
    const ground = new THREE.Mesh(new THREE.CircleGeometry(20, 64), new THREE.MeshStandardMaterial({ color: 0x16412F, roughness: 1 })); ground.rotation.x = -Math.PI / 2; ground.receiveShadow = true; group.add(ground);
    // trunk
    const trunk = new THREE.Mesh(new THREE.CylinderGeometry(1.4, 2.2, 14, 24, 1), BARK()); trunk.position.y = 7; trunk.castShadow = true; group.add(trunk);
    for (let i = 0; i < 6; i++) { const root = new THREE.Mesh(new THREE.CylinderGeometry(.25, .6, 3, 8), BARK()); const a = i * Math.PI / 3; root.position.set(Math.cos(a) * 2.6, .6, Math.sin(a) * 2.6); root.rotation.z = Math.cos(a) * .9; root.rotation.x = -Math.sin(a) * .9; group.add(root); }
    // canopy
    for (let i = 0; i < 9; i++) { const c = new THREE.Mesh(new THREE.SphereGeometry(2.4 + Math.random() * 1.6, 18, 14), new THREE.MeshStandardMaterial({ color: [0x1F5A3E, 0x2A6B48, 0x3F6B4E][i % 3], roughness: 1 })); const a = i * .7; c.position.set(Math.cos(a) * 3 * (i % 3 ? 1 : .3), 13 + Math.random() * 2.5, Math.sin(a) * 3 * (i % 3 ? 1 : .3)); group.add(c); }
    // spiral shelves with books + lanterns
    const shelves = new THREE.Group(); group.add(shelves);
    const books = [];
    BOOKS.forEach((b, i) => {
      const a = i * .62, r = 2.9 + (i % 2) * .2, y = 1.6 + i * .9;
      const plank = new THREE.Mesh(new THREE.BoxGeometry(2.2, .16, 1.1), WOOD()); plank.position.set(Math.cos(a) * r, y - .95, Math.sin(a) * r); plank.rotation.y = -a; plank.castShadow = true; shelves.add(plank);
      const brace = new THREE.Mesh(new THREE.BoxGeometry(.12, .9, .12), WOOD()); brace.position.set(Math.cos(a) * (r + .8), y - 1.45, Math.sin(a) * (r + .8)); shelves.add(brace);
      const m = bookMesh(b, .95); m.position.set(Math.cos(a) * r, y, Math.sin(a) * r); m.rotation.y = -a + Math.PI / 2; m.rotation.z = -.08; shelves.add(m); books.push({ m, ph: i });
      if (i % 3 === 0) { const lan = new THREE.Mesh(new THREE.BoxGeometry(.28, .4, .28), new THREE.MeshStandardMaterial({ color: 0xFFE7A8, emissive: 0xF2CF7A, emissiveIntensity: 1.3 })); lan.position.set(Math.cos(a) * (r + 1.1), y + .3, Math.sin(a) * (r + 1.1)); shelves.add(lan); const cap = new THREE.Mesh(new THREE.ConeGeometry(.28, .2, 4), BRASS()); cap.position.copy(lan.position); cap.position.y += .3; shelves.add(cap); const pl = new THREE.PointLight(0xF2CF7A, 1, 7); pl.position.copy(lan.position); shelves.add(pl); }
    });
    // treehouse cabin
    const cabin = new THREE.Mesh(new THREE.BoxGeometry(3.2, 2.4, 2.8), WOOD()); cabin.position.set(-1.2, 12.2, 1.6); group.add(cabin);
    const roof = new THREE.Mesh(new THREE.ConeGeometry(2.8, 1.6, 4), new THREE.MeshStandardMaterial({ color: 0x3F6B4E })); roof.position.set(-1.2, 14.2, 1.6); roof.rotation.y = Math.PI / 4; group.add(roof);
    const win = new THREE.Mesh(new THREE.PlaneGeometry(.9, .9), new THREE.MeshBasicMaterial({ color: 0xFFD98A })); win.position.set(-1.2, 12.3, 3.02); group.add(win); const wl = new THREE.PointLight(0xF2CF7A, 1.2, 10); wl.position.set(-1.2, 12.3, 3.6); group.add(wl);
    // fireflies & leaves
    const ff = fireflies(220, 26, 0, 12); scene.add(ff);
    const leaves = []; const leafMat = new THREE.MeshStandardMaterial({ color: 0xB8892A, side: THREE.DoubleSide, roughness: .9 });
    for (let i = 0; i < 40; i++) { const l = new THREE.Mesh(new THREE.PlaneGeometry(.35, .2), i % 3 ? leafMat : new THREE.MeshStandardMaterial({ color: 0x7FA36C, side: THREE.DoubleSide })); l.position.set((Math.random() - .5) * 26, Math.random() * 14, (Math.random() - .5) * 14); l.userData = { sp: .6 + Math.random(), ph: Math.random() * 6 }; scene.add(l); leaves.push(l); }
    ...
    return { render(dt, el) {
      ...
      shelves.rotation.y = el * .12 + mx * .4;
      camera.position.x = 5 + mx * 2.5; camera.position.y = 3 - my * 1.8; camera.lookAt(4, 3.2, 0);
      books.forEach((b) => { b.m.rotation.z = -.08 + Math.sin(el * 1.4 + b.ph) * .04; });
      ff.tick(dt, el);
      leaves.forEach((l) => { const u = l.userData; l.position.y -= dt * u.sp; l.position.x += Math.sin(el * 1.3 + u.ph) * .01; l.rotation.x += dt * 1.5; l.rotation.y += dt * .8; if (l.position.y < -3.5) l.position.y = 14; });
      renderer.render(scene, camera);
    } };
  })();

  /* ---------------- 9. Exhibition engine: spiral shelf / firefly circle / mushroom stands ---------------- */
  function Exhibition(canvas, captionEl, tooltipEl, onPick) {
    const renderer = makeRenderer(canvas);
    const scene = new THREE.Scene(); scene.fog = new THREE.FogExp2(0x081A14, .035);
    const camera = new THREE.PerspectiveCamera(44, 2, .1, 100); camera.position.set(0, 4, 15);
    scene.add(new THREE.HemisphereLight(0x3F6B4E, 0x1A120A, .8));
    const moon = new THREE.DirectionalLight(0xBFD8C8, .55); moon.position.set(-6, 14, 6); moon.castShadow = true; scene.add(moon);
    const warm = new THREE.PointLight(0xF2CF7A, 1.1, 40); warm.position.set(0, 9, 4); scene.add(warm);
    const ground = new THREE.Mesh(new THREE.CircleGeometry(18, 64), new THREE.MeshStandardMaterial({ color: 0x16412F, roughness: 1 })); ground.rotation.x = -Math.PI / 2; ground.position.y = -.6; ground.receiveShadow = true; scene.add(ground);
    const ff = fireflies(140, 24, 0, 9); scene.add(ff);
    ...
    function set(curation) {
      ...
      if (layout === 'carousel') { // spiral treehouse shelf
        const trunk = new THREE.Mesh(new THREE.CylinderGeometry(1.1, 1.6, 12, 20), BARK()); trunk.position.y = 5; world.add(trunk); deco.push(trunk);
        books.forEach((b, i) => { const a = i * (Math.PI * 2 / Math.max(6, n) * 1.35), r = 3.4, y = .4 + i * .85; const plank = new THREE.Mesh(new THREE.BoxGeometry(2.4, .16, 1.2), WOOD()); plank.position.set(Math.cos(a) * r, y - .95, Math.sin(a) * r); plank.rotation.y = -a; world.add(plank); deco.push(plank); const m = bookMesh(b, 1.05); m.position.set(Math.cos(a) * r, y, Math.sin(a) * r); m.rotation.y = -a + Math.PI / 2; items.push({ m, ph: i }); world.add(m); if (i % 2) { const pl = new THREE.PointLight(0xF2CF7A, .6, 5); pl.position.set(Math.cos(a) * (r + 1), y + .6, Math.sin(a) * (r + 1)); world.add(pl); deco.push(pl); } });
      } else if (layout === 'balloon') { // firefly circle
        const ringGeo = new THREE.RingGeometry(5.4, 5.6, 64); const ring = new THREE.Mesh(ringGeo, new THREE.MeshBasicMaterial({ color: 0xE3B341, transparent: true, opacity: .5, side: THREE.DoubleSide })); ring.rotation.x = -Math.PI / 2; ring.position.y = -.58; world.add(ring); deco.push(ring);
        for (let i = 0; i < 10; i++) { const a = (i / 10) * Math.PI * 2; const stone = new THREE.Mesh(new THREE.DodecahedronGeometry(.45), new THREE.MeshStandardMaterial({ color: 0x5E6B5A, roughness: 1 })); stone.position.set(Math.cos(a) * 8, -.35, Math.sin(a) * 8); world.add(stone); deco.push(stone); }
        books.forEach((b, i) => { const a = (i / n) * Math.PI * 2; const stump = new THREE.Mesh(new THREE.CylinderGeometry(.7, .8, 1, 12), BARK()); stump.position.set(Math.cos(a) * 5.5, -.1, Math.sin(a) * 5.5); world.add(stump); deco.push(stump); const m = bookMesh(b, 1.05); m.position.set(Math.cos(a) * 5.5, 1.4, Math.sin(a) * 5.5); m.rotation.y = -a + Math.PI / 2; items.push({ m, ph: i }); world.add(m); const glow = new THREE.Mesh(new THREE.SphereGeometry(.12, 10, 10), new THREE.MeshBasicMaterial({ color: 0xFFF2B0 })); glow.position.set(Math.cos(a) * 5.5, 3, Math.sin(a) * 5.5); glow.userData.ph = i; world.add(glow); deco.push(glow); const pl = new THREE.PointLight(0xF2CF7A, .8, 5); pl.position.copy(glow.position); world.add(pl); deco.push(pl); });
      } else { // mushroom stands
        const cols = 4;
        books.forEach((b, i) => { const c = i % cols, row = Math.floor(i / cols); const x = (c - (cols - 1) / 2) * 3.6 + (row % 2) * .9, z = row * -3.6 + 1.5, h = 1.2 + ((i * 7) % 4) * .55; const stem = new THREE.Mesh(new THREE.CylinderGeometry(.35, .55, h, 12), new THREE.MeshStandardMaterial({ color: 0xF4EDDC, roughness: .9 })); stem.position.set(x, h / 2 - .6, z); world.add(stem); deco.push(stem); const cap = new THREE.Mesh(new THREE.SphereGeometry(1.5, 24, 12, 0, Math.PI * 2, 0, Math.PI / 2), new THREE.MeshStandardMaterial({ color: [0xB8402E, 0xE3B341, 0x8B5E3C][i % 3], roughness: .7 })); cap.position.set(x, h - .6, z); cap.scale.y = .45; world.add(cap); deco.push(cap); for (let k = 0; k < 4; k++) { const dot = new THREE.Mesh(new THREE.SphereGeometry(.13, 8, 8), new THREE.MeshStandardMaterial({ color: 0xFFF6E0 })); const da = k * 1.6 + i; dot.position.set(x + Math.cos(da) * .9, h - .6 + .35, z + Math.sin(da) * .9); world.add(dot); deco.push(dot); } const m = bookMesh(b, .95); m.position.set(x, h - .6 + 1.05, z); m.rotation.y = (c - 1.5) * -.25; items.push({ m, ph: i }); world.add(m); });
      }
    ...
    function render(dt, el) {
      fit(renderer, camera, canvas);
      if (!dragging) targetRot += dt * (layout === 'stairs' ? .08 : .16);
      rotY += (targetRot - rotY) * .08; world.rotation.y = rotY; ff.tick(dt, el);
      items.forEach((it) => { it.m.position.y += Math.sin(el * 1.4 + it.ph) * .002; });
      deco.forEach((d) => { if (d.userData.ph !== undefined) d.position.y = 3 + Math.sin(el * 1.2 + d.userData.ph) * .3; });
      if (layout === 'carousel') { camera.position.set(0, 5.5, 15); camera.lookAt(0, 3, 0); }
      else if (layout === 'balloon') { camera.position.set(0, 4.5, 15); camera.lookAt(0, 1.2, 0); }
      else { camera.position.set(0, 4, 14); camera.lookAt(0, 1.2, -1); }
  ...
  /* ---------------- 10. Falling-leaf books (new arrivals 3D) ---------------- */
  const parade = (() => {
    const canvas = $('#parade-canvas'); const renderer = makeRenderer(canvas);
    const scene = new THREE.Scene(); const camera = new THREE.PerspectiveCamera(36, 2, .1, 100); camera.position.set(0, 0, 13); camera.lookAt(0, 0, 0);
    scene.add(new THREE.HemisphereLight(0xFFF6E5, 0x3F6B4E, 1)); const dl = new THREE.DirectionalLight(0xffffff, .8); dl.position.set(4, 10, 6); scene.add(dl);
    const items = NEW_IDS.map((id, i) => { const m = bookMesh(byId(id), .95); m.position.set(-9 + (i % 4) * 6 + (i > 3 ? 3 : 0), 8 - Math.random() * 16, i > 3 ? -3 : 0); m.userData.sp = .5 + Math.random() * .5; m.userData.ph = i; scene.add(m); return { m }; });
    const leaves = []; for (let i = 0; i < 30; i++) { const l = new THREE.Mesh(new THREE.PlaneGeometry(.4, .22), new THREE.MeshStandardMaterial({ color: i % 2 ? 0xB8892A : 0x7FA36C, side: THREE.DoubleSide })); l.position.set((Math.random() - .5) * 24, (Math.random() - .5) * 16, -4 + Math.random() * 6); l.userData = { sp: .8 + Math.random(), ph: Math.random() * 6 }; scene.add(l); leaves.push(l); }
    ...
    return { render(dt, el) {
      fit(renderer, camera, canvas);
      items.forEach((it) => { const u = it.m.userData; it.m.position.y -= dt * u.sp; if (it.m.position.y < -7) it.m.position.y = 8; it.m.position.x += Math.sin(el * .9 + u.ph) * .012; it.m.rotation.z = Math.sin(el * .9 + u.ph) * .35; it.m.rotation.y = Math.sin(el * .5 + u.ph) * .5; });
      leaves.forEach((l) => { const u = l.userData; l.position.y -= dt * u.sp; l.position.x += Math.sin(el * 1.2 + u.ph) * .015; l.rotation.x += dt * 1.6; l.rotation.z += dt * .7; if (l.position.y < -8) l.position.y = 8; });
  ...
  const detail3d = (() => {
    ...
    scene.add(new THREE.HemisphereLight(0x3F6B4E, 0x1A120A, .8)); const s = new THREE.SpotLight(0xF2CF7A, 1.5, 40, .7, .6); s.position.set(3, 7, 6); scene.add(s); const p = new THREE.PointLight(0xF2CF7A, .8, 20); p.position.set(-4, 2, 3); scene.add(p);
    const pedestal = new THREE.Mesh(new THREE.CylinderGeometry(1.6, 1.8, .25, 48), new THREE.MeshStandardMaterial({ color: 0x5A3A22, roughness: .95 })); pedestal.position.y = -1.6; scene.add(pedestal);
  ...
  function saveCart() { localStorage.setItem('mlm19_cart', JSON.stringify(cart)); updateBadges(); if (currentPage === 'cart') renderCart(); }
  ...
  $('#lang-select').addEventListener('change', (e) => { lang = e.target.value; localStorage.setItem('mlm19_lang', lang); applyI18n(); });
  $('#librarian-toggle').addEventListener('change', (e) => { document.body.classList.toggle('librarian', e.target.checked); localStorage.setItem('mlm19_lib', e.target.checked ? '1' : '0'); });
  if (localStorage.getItem('mlm19_lib') === '1') { $('#librarian-toggle').checked = true; document.body.classList.add('librarian'); }
  $('#sound-toggle').addEventListener('click', () => { soundOn = !soundOn; localStorage.setItem('mlm19_sound', soundOn ? 'on' : 'off'); $('#sound-on').hidden = !soundOn; $('#sound-off').hidden = soundOn; });
  ...
  $('#btn-xlsx').addEventListener('click', () => {
    ...
    const ws = XLSX.utils.json_to_sheet(rows); const wb = XLSX.utils.book_new(); XLSX.utils.book_append_sheet(wb, ws, 'Quote'); XLSX.writeFile(wb, `library_quote_v19_${Date.now()}.xlsx`); toast(t('xlsxDone'));
  });
